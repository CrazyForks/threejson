/**
 * Ported verbatim from tools/scene-host/threebox/js/threeBoxMarkdown.js (no @threejson/* package
 * exposes it, so the app carries it — the original pulls `marked`/`dompurify` from esm.sh via an
 * importmap; here they're npm deps resolved by Vite).
 */
